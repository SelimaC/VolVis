...
public class TransferFunction2DEditor extends javax.swing.JPanel {
    ...
    public TransferFunction2DEditor(Volume volume, GradientVolume gradientvolume) {
        ...
        triangleWidget = new TriangleWidget((short) (maxIntensity / 2), maxGradientMagnitude);
        setSelectedInfo();
    }
    ...
    private void colorButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_colorButtonActionPerformed
        ...
        if (newColor != null) {
            ...
            System.out.println("Selected color: " + triangleWidget.color);
            changed();
        }
    ...
    public class TriangleWidget {
        ...
        public TriangleWidget(short base, double maxGrad) {
